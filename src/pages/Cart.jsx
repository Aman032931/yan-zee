      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex min-h-[500px] flex-col items-center justify-center rounded-2xl border border-gray-200 bg-gray-50 px-6 text-center">
          ...
          <p className="mt-2 max-w-md text-sm text-gray-500">
            Discover new styles and home essentials from the YanZee
            collection.
          </p>
        ...
        <div className="flex flex-col gap-2 border-b border-gray-200 pb-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              {cart.length} product
              {cart.length !== 1 ? "s" : ""} · {totalItems} item
              {totalItems !== 1 ? "s" : ""}
            </p>
          </div>
        ...
        <div className="mt-8 grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_370px]">
          <div className="space-y-4">
            ...
            <button
              type="button"
              onClick={clearCart}
              className="text-xs font-medium text-gray-500 underline underline-offset-4 hover:text-red-600"
            >
              Clear bag
            </button>
          </div>
          ...
          <aside className="lg:sticky lg:top-6">
            <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6">
              ...
              <Link
                to="/checkout"
                className="mt-6 flex h-12 items-center justify-center rounded-md bg-black px-5 text-sm font-semibold text-white hover:bg-gray-800"
              >
                Proceed to Checkout
              </Link>

              <p className="mt-3 text-center text-[11px] text-gray-500">
                Secure checkout · Free shipping over Rs. 3,000
              </p>
            </div>
          </aside>
        </div>
