...
export default function Premium() {
  ...
  const clearFilters = () => { setMaxPrice(900000); setOnlyNewArrivals(false); setVisibleCount(8); };
  ...
  return (
    <div className="mx-auto max-w-[1440px] px-4 pt-8 pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-8 items-start">
        <div>
          <PremiumFilterPanel maxPrice={maxPrice} setMaxPrice={setMaxPrice} onlyNewArrivals={onlyNewArrivals} setOnlyNewArrivals={setOnlyNewArrivals} onClearFilters={clearFilters} />
        </div>
